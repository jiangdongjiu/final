...
if __name__ == "__main__":
    ...
    pprint.pprint(my_plot_operations.receive_and_format_data(1996, 11))
    my_plot_operations.generate_boxplot(1996, 1997)
    my_plot_operations.generate_lineplot(1996, 11)
